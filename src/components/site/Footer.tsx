        ...
        <div className="grid gap-12 md:grid-cols-4">
          <div>
            ...
            <div className="mt-6 flex gap-4">
              <a
                ...
                className="text-cream/70 hover:text-pistachio-light"
              >
                <Instagram className="h-5 w-5" />
              </a>
              <a
                href="https://www.tiktok.com/@getstesh"
                aria-label="TikTok"
                className="text-cream/70 hover:text-pistachio-light text-sm font-bold"
              >
                TT
              </a>
              <a
                href="https://www.linkedin.com/company/stesh-pistachio-butter"
                aria-label="LinkedIn"
                className="text-cream/70 hover:text-pistachio-light text-sm font-bold"
              >
                in
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-cream/70">
              <li>
                <Link to="/product" className="hover:text-cream">
                  Pistachio Butter
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/where-to-buy" className="hover:text-cream">
                  Find in Store
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-cream/70">
              ...
              <li>
                <Link to="/wholesale" className="hover:text-cream">
                  Wholesale
                </Link>
              </li>
              <li>
                <Link to="/recipes" className="hover:text-cream">
                  Recipes
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-cream/70">
              <li>
                <a href="mailto:connect@steshbutter.com" className="hover:text-cream">
                  Contact
                </a>
              </li>
              <li>
