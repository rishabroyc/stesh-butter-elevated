...
const locations = [
  { name: "Hunger Mountain Co-op", neighborhood: "Montpelier, VT", address: "623 Stone Cutters Way", city: "Montpelier", state: "VT", zip: "05602", lat: 44.2601, lng: -72.5806 },
  { name: "Adams Fairacre Farms", neighborhood: "Poughkeepsie, NY", address: "765 Dutchess Turnpike", city: "Poughkeepsie", state: "NY", zip: "12603", lat: 41.6868, lng: -73.9034 },
  { name: "Bantam Market", neighborhood: "Bantam, CT", address: "793 Bantam Rd", city: "Bantam", state: "CT", zip: "06750", lat: 41.7262, lng: -73.2420 },
  { name: "Morning Glory Farm", neighborhood: "Edgartown, MA", address: "120 Meshacket Rd", city: "Edgartown", state: "MA", zip: "02539", lat: 41.3884, lng: -70.5423 },
  { name: "Adams Fairacre Farms", neighborhood: "Middletown, NY", address: "1740 Route 211 E", city: "Middletown", state: "NY", zip: "10941", lat: 41.4466, lng: -74.3197 },
  { name: "Pawtuxet Village Market", neighborhood: "Cranston, RI", address: "2180 Broad St", city: "Cranston", state: "RI", zip: "02905", lat: 41.7750, lng: -71.4380 },
  { name: "Bartlett's Ocean View Farm", neighborhood: "Nantucket, MA", address: "33 Bartlett Farm Rd", city: "Nantucket", state: "MA", zip: "02554", lat: 41.2664, lng: -70.0882 },
  { name: "Cider Hill Farm", neighborhood: "Amesbury, MA", address: "45 Fern Ave", city: "Amesbury", state: "MA", zip: "01913", lat: 42.8590, lng: -70.9299 },
  { name: "Northville Market", neighborhood: "New Milford, CT", address: "301 Litchfield Rd #2", city: "New Milford", state: "CT", zip: "06776", lat: 41.5860, lng: -73.4063 },
  { name: "Belmont Marketplace", neighborhood: "Wakefield, RI", address: "600 Kingstown Rd", city: "Wakefield", state: "RI", zip: "02879", lat: 41.4440, lng: -71.5210 },
];
